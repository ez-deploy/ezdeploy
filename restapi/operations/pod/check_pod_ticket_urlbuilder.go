...
func (o *CheckPodTicketURL) Build() (*url.URL, error) {
	...
	var _path = "/visit/pod/ticket/check"
	...
	ticketValueQ := o.TicketValue
	if ticketValueQ != "" {
		qs.Set("ticket_value", ticketValueQ)
	}
...
func (o *CheckPodTicketURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CheckPodTicketURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CheckPodTicketURL")
	}
