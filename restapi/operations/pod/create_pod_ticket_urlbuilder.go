...
func (o *CreatePodTicketURL) Build() (*url.URL, error) {
	...
	var _path = "/visit/pod/ticket/create"
...
func (o *CreatePodTicketURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreatePodTicketURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreatePodTicketURL")
	}
