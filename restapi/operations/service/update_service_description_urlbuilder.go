...
func (o *UpdateServiceDescriptionURL) WithBasePath(bp string) *UpdateServiceDescriptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateServiceDescriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateServiceDescriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateServiceDescriptionURL")
	}
