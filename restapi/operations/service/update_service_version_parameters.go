...
// UpdateServiceVersionParams contains all the bound params for the update service version operation
...
func (o *UpdateServiceVersionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
