...
func (o *UpdateServiceVersionURL) WithBasePath(bp string) *UpdateServiceVersionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateServiceVersionURL) Build() (*url.URL, error) {
	...
	var _path = "/service/update/deploy"
...
func (o *UpdateServiceVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateServiceVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateServiceVersionURL")
	}
