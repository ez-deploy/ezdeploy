...
// GetServiceVersionParams contains all the bound params for the get service version operation
...
func (o *GetServiceVersionParams) bindVersionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
	...
	value, err := swag.ConvertInt64(raw)
	if err != nil {
		return errors.InvalidType("version_id", "query", "int64", raw)
	}
	o.VersionID = value
