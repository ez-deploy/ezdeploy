...
func (o *CreateServiceVersionURL) WithBasePath(bp string) *CreateServiceVersionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateServiceVersionURL) Build() (*url.URL, error) {
	...
	var _path = "/service/version/create"
...
func (o *CreateServiceVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateServiceVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateServiceVersionURL")
	}
