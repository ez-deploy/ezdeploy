...
func (fn GetServiceVersionHandlerFunc) Handle(params GetServiceVersionParams, principal *models.AuthInfo) middleware.Responder {
...
func NewGetServiceVersion(ctx *middleware.Context, handler GetServiceVersionHandler) *GetServiceVersion {
	return &GetServiceVersion{Context: ctx, Handler: handler}
}
...
func (o *GetServiceVersion) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetServiceVersionParams()
