...
func (o *GetServiceVersionURL) Build() (*url.URL, error) {
	...
	versionIDQ := swag.FormatInt64(o.VersionID)
	if versionIDQ != "" {
...
func (o *GetServiceVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServiceVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServiceVersionURL")
	}
