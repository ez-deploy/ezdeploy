...
// ListServiceVersionParams contains all the bound params for the list service version operation
...
func (o *ListServiceVersionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListServiceVersionParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
