...
// CreateServiceVersionParams contains all the bound params for the create service version operation
...
func (o *CreateServiceVersionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceVersion
