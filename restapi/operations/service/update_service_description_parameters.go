...
// UpdateServiceDescriptionParams contains all the bound params for the update service description operation
...
func (o *UpdateServiceDescriptionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
