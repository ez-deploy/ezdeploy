...
func (o *ListServiceVersionURL) Build() (*url.URL, error) {
	...
	var _path = "/service/version/list"
...
func (o *ListServiceVersionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListServiceVersionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListServiceVersionURL")
	}
