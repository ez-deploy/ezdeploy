...
// GetProjectRBACParams contains all the bound params for the get project r b a c operation
...
func (o *GetProjectRBACParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
