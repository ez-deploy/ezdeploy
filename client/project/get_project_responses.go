...
List All Projects Success, return project info. (project name, project id, project description)
*/
...
func (o *GetProjectOK) Error() string {
	return fmt.Sprintf("[GET /project/get][%d] getProjectOK  %+v", 200, o.Payload)
}
...
Get Project Failed, cause project not exist
*/
...
func (o *GetProjectNotFound) Error() string {
	return fmt.Sprintf("[GET /project/get][%d] getProjectNotFound  %+v", 404, o.Payload)
}
...
func (o *GetProjectInternalServerError) Error() string {
	return fmt.Sprintf("[GET /project/get][%d] getProjectInternalServerError  %+v", 500, o.Payload)
}
